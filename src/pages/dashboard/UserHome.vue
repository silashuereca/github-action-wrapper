<template>
  <div>
    ...
    <div>
      ...
      <button type="button" @click="checkAuthSession">Check Auth Session</button>
    </div>

    <div class="w-96">
      <label for="location" class="block text-sm/6 font-medium text-gray-900">Repositories</label>
      <div class="mt-2 grid grid-cols-1">
        <select id="location" v-model="state.form.repo" name="location"
    ...
    <button class="mt-5" type="button" @click="buildWorkflow()">Build Workflow</button>
